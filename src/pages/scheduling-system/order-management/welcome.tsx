...
function Welcome({ data }: Props) {
  ...
  const [selectedEvent, setSelectedEvent] = useState({eventId: '', scheduleId: ''})
  ...
  const setNextStep = async (e: CardProps) => {
    setSelectedEvent({eventId: e.id, scheduleId: e.schedule})
    setIsOpen(true)
  }
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Apakah kamu mau menambahkan produk lain-lain, seperti makanan dan minuman?
                    </p>
                  </div>
                  ...
                  <div className="mt-4 space-y-2">
                    <button
                      type="button"
                      className="w-full inline-flex justify-center rounded-md border border-transparent bg-gray-50 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                      onClick={closeModal}
                    >
