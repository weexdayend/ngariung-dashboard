...
import ViewDataInventory from './view_data_inventory';
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                ...
                <th className="py-3 px-6 text-left">Beginning</th>
                <th className="py-3 px-6 text-left">Production</th>
                <th className="py-3 px-6 text-left">Purchasing</th>
                <th className="py-3 px-6 text-left">Usage</th>
                <th className="py-3 px-6 text-left">Transfer</th>
                <th className="py-3 px-6 text-left">Adjusment</th>
                <th className="py-3 px-6 text-left">Ending</th>
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {
                productData.map((productItem, i) => (
                  ...
                  <tr className='hover:bg-gray-50' key={i}>
                    <td className="py-4 px-6 flex flex-col text-sm cursor-pointer" onClick={() => handleClick(true,'View Data')}>
                    ...
                    <td className="py-4 px-6 text-center text-sm">{productItem.beginning}</td>
                    <td className="py-4 px-6 text-center text-sm">{productItem.production}</td>
                    <td className="py-4 px-6 text-center text-sm">{productItem.purchasing}</td>
                    <td className="py-4 px-6 text-center text-sm">{productItem.usage}</td>
                    <td className="py-4 px-6 text-center text-sm">{productItem.transfer}</td>
                    <td className="py-4 px-6 text-center text-sm">
                      {productItem.adjusment > 0 ? `-${productItem.adjusment}` : `${productItem.adjusment}`}
                    </td>
                    <td className="py-4 px-6 text-center text-sm">{productItem.ending}</td>
                    <td className="py-4 px-6 text-left text-sm">{productItem.unit}</td>
                  </tr>
                  </>
                ))
              }
