...
import { ingredientCategory, ingredientLibrary, productData } from '@/utils/typeData';
import PanelComponent from '../../../components/panel_component';

type Props = {}

function TableIngredientCategory({}: Props) {
      ...
      <div className='flex'>
        <div className='row-span-1 w-full h-fit px-6 py-6 bg-white rounded-3xl shadow-xl shadow-gray-100'>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                <th className="py-3 px-6 text-left">Ingredient Category Name</th>
                <th className="py-3 px-6 text-left">Ingredient Stock</th>
                <th className="py-3 px-6 text-center"></th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-100">
              {
                ingredientCategory.map((ingredient, i) => (
                  <>
                  <tr className='hover:bg-gray-50' key={i}>
                    <td className="py-4 px-6 text-left text-sm">{ingredient.name}</td>
                    <td className="py-4 px-6 text-left text-sm">{ingredient.ingredientStock} Ingredients</td>
