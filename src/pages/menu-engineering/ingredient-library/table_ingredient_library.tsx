...
import { ingredientLibrary, productData } from '@/utils/typeData';
import PanelComponent from '../../../components/panel_component';

type Props = {}

function TableIngredientLibrary({}: Props) {
        ...
        <div className='row-span-1 w-full h-fit px-6 py-6 bg-white rounded-3xl shadow-xl shadow-gray-100'>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {
                ingredientLibrary.map((ingredient, i) => (
                  <>
                  <tr className='hover:bg-gray-50' key={i}>
                    <td className="py-4 px-6 text-left text-sm">{ingredient.name}</td>
                    <td className="py-4 px-6 text-left text-sm">{ingredient.category}</td>
                    <td className="py-4 px-6 text-center text-sm">{ingredient.instock}</td>
                    <td className="py-4 px-6 text-left text-sm">{ingredient.unit}</td>
                    <td className="py-4 px-6 text-center text-sm">{ingredient.alertstock}</td>
                  </tr>
                  </>
                ))
              }
...
export default TableIngredientLibrary